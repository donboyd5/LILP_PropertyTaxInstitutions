...
scenarios <- c("shock-adjust.fast-20pct.res",
               "shock-adjust.fast-80pct.res",
               "shock-adjust.slow-20pct.res",
               "shock-adjust.slow-80pct.res")

# scenarios <- c("shock-adjust.slow-20pct.res",
#                "shock-adjust.slow-80pct.res",
#                "shock-adjust.fast-80pct.res")

pdata <- results %>%
  filter(year <= 15, fullname %in% scenarios) %>%
